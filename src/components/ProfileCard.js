...
class ProfileCard extends Component {
  render(){
    return(<div className='projectCard float-left'>
      <img className="photo" src="https://i.pinimg.com/736x/87/35/f0/8735f09361805f96103937a89eaf24ea--retro-photography-registered-nurses.jpg" alt="Pike Place Market sign"/>
      <h2>Jamie Degnan</h2>
